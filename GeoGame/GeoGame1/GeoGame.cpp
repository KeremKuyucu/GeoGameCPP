...
int main(void) {
	...
	do {
		...
		if (result) {
			kerem = true;
			cerr << "\033[1;33mUygulama açılamadı. 3 Saniye Sonra Tekrar denenecek.\nEğer hala açılmıyor ise\n\033[1;34mC:\\Users\\Ortak\\Documents\\cografyaoyun \033[1;33mkonunuma giderek oyunu CografyaOyun.exe dosyasını açarak başlatabilirsiniz.\033[1;31m" << endl;
			Sleep(3000); // 3 saniye bekleme
		}
		futures.clear();
	} while (result);
	cout << "\033[1;34mBaşarıyla Açıldı!\033[0m" << endl;
	return 0;
}
